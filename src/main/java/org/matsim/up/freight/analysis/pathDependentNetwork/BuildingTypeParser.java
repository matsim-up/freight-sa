...
package org.matsim.up.freight.analysis.pathDependentNetwork;
...
import org.matsim.up.utils.grid.KernelDensityEstimator;
...
public class BuildingTypeParser extends AbstractAnalysis{
	...
	public static void main(String[] args) {
		Header.printHeader(BuildingTypeParser.class, args);
