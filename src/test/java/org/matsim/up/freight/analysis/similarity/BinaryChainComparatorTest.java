package org.matsim.up.freight.analysis.similarity;
...
import org.matsim.up.freight.analysis.chain.similarity.BinaryChainComparator;
...
public class BinaryChainComparatorTest {
	...
	public void testConstructor(){
		DigicoreVehicle vehicle = setupVehicleWithTwoChains();
		BinaryChainComparator cc = new BinaryChainComparator(vehicle);
