 ...
 * 
 */
package org.matsim.up.freight.run;
...
import org.matsim.up.freight.algorithms.complexNetwork.DigicorePathDependentNetworkReader_v1;
...
//	private static String HOME = "/Users/jwjoubert/Documents/Temp/freightPopulation/runs/01perc/";
	...
	public static void main(String[] args) {
		Header.printHeader(RunNationalFreight.class, args);
		if(args.length == 5){
			NETWORK = args[0];
			POPULATION = args[1];
