...
import org.matsim.up.freight.utils.DigicoreUtils;
 ...
 * on a given day (type).
 * 
 * FIXME This class should be upgraded to use {@link DigicoreVehicles}.
 * 
 * @author jwjoubert
 */
public class BootstrapPopulationGenerator {
	...
	public static void main(String[] args) {
		Header.printHeader(BootstrapPopulationGenerator.class, args);
