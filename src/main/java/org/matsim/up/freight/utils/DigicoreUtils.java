...
public class DigicoreUtils {
	...
	/**
	 * Samples a given fraction (must be less than or equal to 1) of {@link DigicoreVehicle}s
	 * from a given container and returns them in a new {@link DigicoreVehicles} container.
	 * 
	 * @param dvIn
	 * @param fraction
	 * @return
	 */
	public DigicoreVehicles sampleDigicoreVehicles(DigicoreVehicles dvIn, double fraction) {
		if(fraction > 1.0) {
			LOG.error("Fraction should be less than 1.0 to be useful.");
		}
